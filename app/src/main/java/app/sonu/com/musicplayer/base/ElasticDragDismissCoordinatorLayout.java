package app.sonu.com.musicplayer.base;
...
/**
 * Created by sonu on 25/8/17.
 */

public class ElasticDragDismissCoordinatorLayout extends CoordinatorLayout implements NestedScrollingParent {

    private com.commit451.elasticdragdismisslayout.ElasticDragDismissDelegate mDelegate;
...
//    @TargetApi(21)
//    public ElasticDragDismissCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
