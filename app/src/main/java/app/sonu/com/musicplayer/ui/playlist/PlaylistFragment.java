...
public class PlaylistFragment extends BaseFragment<PlaylistMvpPresenter> implements PlaylistMvpView {

    private static final String TAG = PlaylistFragment.class.getSimpleName();

    public static final String BACK_STACK_TAG = "__playlistfragment__";
    ...
    public void displayListData(final MediaBrowserCompat.MediaItem item,
        ...
        options.centerCrop().placeholder(R.drawable.default_playlist_art);
        ...
        if (artPath != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                artIv.setImageDrawable(getActivity().getDrawable(R.drawable.default_playlist_art));
            } else {
                artIv.setImageDrawable(
                        getActivity()
                                .getResources()
                                .getDrawable(R.drawable.default_playlist_art));
            }
