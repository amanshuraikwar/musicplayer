...
public class MediaListHeaderPaddedViewHolder extends BaseViewHolder<MediaListHeaderPaddedVisitable,
        MediaListHeaderOnClickListener> {

    @LayoutRes
    public static final int LAYOUT = R.layout.item_media_list_header_padded;
    ...
    public MediaListHeaderPaddedViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bind(final MediaListHeaderPaddedVisitable visitable,
