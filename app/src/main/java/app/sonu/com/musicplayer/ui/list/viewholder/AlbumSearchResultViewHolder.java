...
public class AlbumSearchResultViewHolder extends BaseViewHolder<AlbumSearchResultVisitable,
        AlbumSearchResultOnClickListener> {

    @LayoutRes
    public static final int LAYOUT = R.layout.item_album_search_result;
    ...
    public AlbumSearchResultViewHolder(View itemView) {
        super(itemView);
    }
