...
public class ArtistSongVisitable extends BaseVisitable<SongOnClickListener, MediaListTypeFactory> {

    private MediaBrowserCompat.MediaItem item;

    public ArtistSongVisitable(MediaBrowserCompat.MediaItem item) {
        this.item = item;
    }
