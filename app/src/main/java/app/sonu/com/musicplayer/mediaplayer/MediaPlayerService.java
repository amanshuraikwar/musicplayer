...
public class MediaPlayerService extends Service
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ...
            audioList = prefsHelper.getSongQueue();
            audioIndex = prefsHelper.getCurrentSongIndex();

            Log.i("yoyoyo", audioIndex+"");
...
//        new StorageUtil(getApplicationContext()).clearCachedAudioPlaylist();
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        new AppPrefsHelper(getApplicationContext()).setCurrentSongIndex(audioIndex+1);
...
//            buildNotification(PlaybackStatus.PAUSED);
    ...
    private BroadcastReceiver playNewAudio = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //Get the new media index form SharedPreferences
            audioIndex = new AppPrefsHelper(getApplicationContext()).getCurrentSongIndex();
            if (audioIndex != -1 && audioIndex < audioList.size()) {
                //index is in a valid range
                activeAudio = audioList.get(audioIndex);
            } else {
...
//        IntentFilter filter = new IntentFilter(MusicPlayerPresenter.Broadcast_PLAY_NEW_AUDIO);
